...
\begin{itemize}
    ...
    Research topics in this area include model pricing, model ownership verification and .... (ref. Section~\ref{}) % TODO:
\end{itemize}
