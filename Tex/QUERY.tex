...
In the first step, we can compare the hash codes of the raw target model or its binary execution to rapidly filter out cases of naive replication plagiarism.
