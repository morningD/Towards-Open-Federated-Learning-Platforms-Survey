...
So, instead of trying to directly concatenate multiple sources of models while dealing with intricate parameter mismatch, transferring the latent knowledge derived from local models to a new model is a good alternative (i.e. Federated Distillation~\cite{jeong2018communication, jin2023feddyn}).
...
The main \textbf{advantage} of distillation in the FL context is the decoupling between knowledge distillation and knowledge learning. 
...
\begin{table}[]
  ...
  \begin{longtable}{|p{1.68cm}|p{1.2cm}|p{1.25cm}|p{5.0cm}|p{2.59cm}|p{1.1cm}|p{0.35cm}|}
    ...
    FedCAVE-Ens~\cite{heinbaughdata2023data} & \textcolor{purple}{Collection}  & & & \textcolor{purple}{Synthetic Data} & \textcolor{purple}{C}[\textcolor{purple}{G}]*1 & H \\
    FedCAVE-KD~\cite{heinbaughdata2023data} &  & & \textcolor{purple}{KD} \textcolor{blue}{\textbf{Softmax}} & & \textcolor{purple}{C}[\textcolor{purple}{GD}]*1 & H \\ \hline
